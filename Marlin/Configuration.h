...
#define STRING_CONFIG_H_AUTHOR "(David Mann, Ender-5 Pro)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 480 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -16.2, 0 }
...
// Travel limits (mm) after homing, corresponding to endstop positions.M206
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
